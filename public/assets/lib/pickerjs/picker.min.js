...
!(function (e, t) {
  ...
  var s = {
    ...
    g = a ? window : {},
    e = !!a && "ontouchstart" in g.document.documentElement,
    i = !!a && "PointerEvent" in g,
    b = "picker",
    o = {},
    y = "next",
    k = "prev",
  ...
  function B(e) {
    ...
    try {
      var t = e.constructor,
        n = t.prototype;
      return t && n && O.call(n, "isPrototypeOf");
    } catch (e) {
      return !1;
    }
  }
      ...
      .forEach(function (i) {
        if (o.once && !G) {
          var e = s.listeners,
            r = void 0 === e ? {} : e;
          (c = function () {
            delete r[i][a], s.removeEventListener(i, c, o);
            for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
              t[n] = arguments[n];
            a.apply(s, t);
          }),
            r[i] || (r[i] = {}),
            r[i][a] && s.removeEventListener(i, r[i][a], o),
            (r[i][a] = c),
            (s.listeners = r);
        }
        s.addEventListener(i, c, o);
      });
  }
  function ee(e, t, n) {
    var i;
  ...
  var se = {
    ...
    ce = {
      ...
      parseDate: function (o) {
        ...
        if (F(o)) {
          var t = n(c.months).concat(n(c.monthsShort), ["\\d+"]);
          if (
    ...
    de = (function () {
      function n(e) {
        ...
        (this.element = e),
          (this.options = W({}, s, o[t.language], B(t) && t)),
          (this.shown = !1),
          this.init();
      }
      var e, t, i;
            ...
            value: function () {
              ...
              if (!$(e, b)) {
                ...
                var r = i.getElementsByClassName(b)[0],
                  ...
                  s = h.container;
                if ((F(s) && (s = document.querySelector(s)), n))
                  J(r, w), J(r, M), s || (s = e);
                else {
                  var a = e.ownerDocument,
                    o = a.body || a.documentElement;
                  (this.body = o),
                    (this.scrollBarWidth =
                      g.innerWidth - a.documentElement.clientWidth),
                ...
                f && (J(u, "".concat(b, "-headers")), (f = B(f) ? f : h.text)),
                  ...
                  this.format.tokens.forEach(function (e) {
                    ...
                    switch (e.charAt(0)) {
                      ...
                      case "M":
                        (s.max = 11),
                          ...
                          (s.offset = 1),
                          3 === s.digit
                            ? (s.aliases = h.monthsShort)
                            : 4 === s.digit && (s.aliases = h.months);
                        break;
                      case "D":
                        (s.max = function () {
                          return te(d.getFullYear(), d.getMonth());
                        }),
                          (s.min = 1);
                        break;
                      case "H":
                    ...
                    u.appendChild(n), (l.data[t] = s), l.render(t);
                  }),
                  n && (s.innerHTML = ""),
                  s.appendChild(r),
                  this.bind();
  ...
  return W(de.prototype, se, ae, oe, ce), (de.languages = o), de;
});
