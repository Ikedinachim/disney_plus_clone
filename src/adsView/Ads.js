...
const ViewCampaign = () => {
    ...
    const { loading, error, createShowAds } = useSelector(state => state.showAds || {});
                            ...
                            <div className="col-md-5 col-12 mg-t-20">
                                        <div className="card shadow-sm rounded bd-0">
                                            <div className="card-body">
                                                ...
                                                <div>
                                                    <img src={createShowAds.attachment} className="img-fluid mg-b-10" alt="" />
                                                    <p className="mb-4">
                                                        {createShowAds.campaignMessage}
                                                    </p>
                                                </div>
                                                <div>
                                                    {createShowAds.callToAction === "" || createShowAds.whatsappNumber === "" ? null :
                                                    ...
                                                    {createShowAds.callToAction === "" || createShowAds.phoneNumber === "" ? null :
                                                        <button className="btn btn-primary w-100 mg-b-15 round-5">
                                                            <i className="fa fa-phone mg-r-5" />
                                                            {createShowAds.callToAction} via Mobile
                                                        </button>
                                                    }
                                                    {createShowAds.callToAction === "" || createShowAds.ussd === "" ? null :
                                                        <button className="btn btn-primary w-100 mg-b-15 round-5">
                                                            <i className="fa fa-phone mg-r-5" />
                                                            {createShowAds.callToAction} USSD
                                                        </button>
                                                    }
                                                    {createShowAds.callToAction === "" || createShowAds.smsNumber === "" ? null :
                                                        <button className="btn btn-primary w-100 mg-b-15 round-5">
