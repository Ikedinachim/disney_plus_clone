...
const ProcessOrder = ({ match }) => {
    ...
    // const order = useSelector(state => state.orderDetails.success || {});
                        ...
                        {loading ? <Loader /> : (
                            <div className="row d-flex justify-content-around">
                                <div className="col-12 col-lg-7 order-details">
                                    ...
                                    <p>
                                        <b>Amount:</b> <NumberFormat value={totalPrice} displayType={'text'} thousandSeparator={true} prefix={'₦'} />
                                    </p>
                                    ...
                                    <h4 className="my-4">Paystack ID</h4>
