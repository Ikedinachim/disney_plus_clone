                    ...
                    <div className="row">
                      ...
                      >
                        ...
                        <p className="tx-14 col-md-10 pd-x-0">
                          Create New Ad to tap into our massive and diverse
                          customer base to market your product and offers.
                        </p>
                        <button
                          type="button"
                          disabled={!isActive}
                    ...
                    <div className="row">
                      ...
                      >
                        ...
                        <p className="tx-14 tx-blac col-md-9 pd-x-0">
                          Tap into Mysogi massive and diverse customer base to
                          market your product and offers.
                        </p>
                        <button
                          type="button"
                          disabled={isActive}
