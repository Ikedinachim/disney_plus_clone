...
import { createAppDownloadCampaignAction, clearErrors } from '../../../../actions/campaignActions';
...
const PreviewCampaign = ({ nextStep, prevStep, values, audience, attachmentPreview, price }) => {
    ...
    const { error, createAppDownloadCampaign, loading } = useSelector(state => state.appDownload || [])
