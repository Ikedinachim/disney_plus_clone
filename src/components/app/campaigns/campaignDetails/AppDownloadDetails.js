                    ...
                    <div className="col-md-6 col-lg-6 mg-b-20 mg-md-b-10">
                      ...
                      <div className="row mg-t-15">
                        ...
                        <div className="form-group col-md-6">
                          ...
                          <p className="tx-16 mb-0">
                            {singleAppCampaign && singleAppCampaign.id}
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6 col-lg-5 mg-b-20 mg-md-b-10">
                      ...
                      <div className="row mg-t-15">
                        ...
                        <div className="form-group col-md-6">
                          ...
                          <p className="tx-16 mb-0">
                            {singleAppCampaign && singleAppCampaign.channel}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6 col-lg-5 mg-b-20 mg-md-b-10">
                      ...
                      <div className="row mg-t-15">
                        <div className="form-group col-md-12">
                          ...
                          <p className="tx-16 mb-0">
                            {singleAppCampaign && singleAppCampaign.cost}
                          </p>
                        </div>
                        ...
                        <div className="form-group col-md-6">
                          ...
                          <p className="tx-16 mb-0">
                            {DateTime.fromJSDate(
                              new Date(
                                singleAppCampaign && singleAppCampaign.createdAt
                              )
                        ...
                        <div className="form-group col-md-6">
                          ...
                          <p className="tx-16 mb-0">
                            {DateTime.fromJSDate(
                              new Date(
                                singleAppCampaign && singleAppCampaign.updatedAt
                              )
                            ).toFormat("dd MMM, yyyy")}
                          </p>
                        </div>
