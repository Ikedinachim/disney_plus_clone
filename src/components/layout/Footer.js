                ...
                <div className="container py-5 tx-white">
                    ...
                    <form action="">
                        ...
                        <div className="input-group-append">
                            <button className="btn btn-primary tx-12 pd-y-5" type="button" id="button-addon2">Subscribe <i className="fa fa-arrow-right mg-l-10 mg-t-3" style={{fontSize: "14px"}}></i></button>
                        </div>
                        </div>
                    </form>
                    </div>
