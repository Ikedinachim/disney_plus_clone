...
export const UPDATE_INFLUENCER_PROFILE_REQUEST =
  "UPDATE_INFLUENCER_PROFILE_REQUEST";
export const UPDATE_INFLUENCER_PROFILE_SUCCESS =
  "UPDATE_INFLUENCER_PROFILE_SUCCESS";
export const UPDATE_INFLUENCER_PROFILE_RESET =
  "UPDATE_INFLUENCER_PROFILE_RESET";
export const UPDATE_INFLUENCER_PROFILE_FAIL = "UPDATE_INFLUENCER_PROFILE_FAIL";

export const UPDATE_INFLUENCER_COST_REQUEST = "UPDATE_INFLUENCER_COST_REQUEST";
export const UPDATE_INFLUENCER_COST_SUCCESS = "UPDATE_INFLUENCER_COST_SUCCESS";
export const UPDATE_INFLUENCER_COST_RESET = "UPDATE_INFLUENCER_COST_RESET";
export const UPDATE_INFLUENCER_COST_FAIL = "UPDATE_INFLUENCER_COST_FAIL";
...
export const UPDATE_INFLUENCER_PASSWORD_REQUEST =
  "UPDATE_INFLUENCER_PASSWORD_REQUEST";
export const UPDATE_INFLUENCER_PASSWORD_SUCCESS =
  "UPDATE_INFLUENCER_PASSWORD_SUCCESS";
export const UPDATE_INFLUENCER_PASSWORD_RESET =
  "UPDATE_INFLUENCER_PASSWORD_RESET";
export const UPDATE_INFLUENCER_PASSWORD_FAIL =
  "UPDATE_INFLUENCER_PASSWORD_FAIL";
export const UPDATE_INFLUENCER_PASSWORD_ACTIVE =
...
export const CONFIRM_USER_RESET = "CONFIRM_USER_RESET";
