...
export const GET_SMS_SINGLE_CAMPAIGN_REQUEST = "GET_SMS_SINGLE_CAMPAIGN_REQUEST";
export const GET_SMS_SINGLE_CAMPAIGN_SUCCESS = "GET_SMS_SINGLE_CAMPAIGN_SUCCESS";
...
export const VIEW_SINGLE_APP_CAMPAIGN_REQUEST = 'VIEW_SINGLE_APP_CAMPAIGN_REQUEST'
export const VIEW_SINGLE_APP_CAMPAIGN_SUCCESS = 'VIEW_SINGLE_APP_CAMPAIGN_SUCCESS'
export const VIEW_SINGLE_APP_CAMPAIGN_FAIL = 'VIEW_SINGLE_APP_CAMPAIGN_FAIL'

export const VIEW_SINGLE_FLIER_CAMPAIGN_REQUEST = 'VIEW_SINGLE_FLIER_CAMPAIGN_REQUEST'
export const VIEW_SINGLE_FLIER_CAMPAIGN_SUCCESS = 'VIEW_SINGLE_FLIER_CAMPAIGN_SUCCESS'
export const VIEW_SINGLE_FLIER_CAMPAIGN_FAIL = 'VIEW_SINGLE_FLIER_CAMPAIGN_FAIL'
