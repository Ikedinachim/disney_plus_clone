...
export const VIEW_FLIER_VIDEO_CAMPAIGN_REQUEST = 'VIEW_FLIER_VIDEO_CAMPAIGN_REQUEST'
export const VIEW_FLIER_VIDEO_CAMPAIGN_SUCCESS = 'VIEW_FLIER_VIDEO_CAMPAIGN_SUCCESS'
export const VIEW_FLIER_VIDEO_CAMPAIGN_FAIL = 'VIEW_FLIER_VIDEO_CAMPAIGN_FAIL'

export const VIEW_APP_DOWNLOAD_CAMPAIGN_REQUEST = 'VIEW_APP_DOWNLOAD_CAMPAIGN_REQUEST'
export const VIEW_APP_DOWNLOAD_CAMPAIGN_SUCCESS = 'VIEW_APP_DOWNLOAD_CAMPAIGN_SUCCESS'
export const VIEW_APP_DOWNLOAD_CAMPAIGN_FAIL = 'VIEW_APP_DOWNLOAD_CAMPAIGN_FAIL'
...
export const GET_FILTERED_CONTACT_LIST_REQUEST = 'GET_FILTERED_CONTACT_LIST_REQUEST'
export const GET_FILTERED_CONTACT_LIST_SUCCESS = 'GET_FILTERED_CONTACT_LIST_SUCCESS'
